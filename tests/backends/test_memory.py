...
@pytest.mark.asyncio
async def test_in_memory_read_write(in_memory: SessionBackend, session_payload: dict) -> None:
...
@pytest.mark.asyncio
async def test_in_memory_remove(in_memory: SessionBackend, session_payload: dict) -> None:
...
@pytest.mark.asyncio
async def test_in_memory_exists(in_memory: SessionBackend, session_payload: dict) -> None:
    await in_memory.write(session_payload, "session_id")
